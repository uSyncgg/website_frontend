...
const EwagersWZ = () => {
  ...
  return (
    <>
        <Helmet>
          <meta name="description" content="EWagers is direct wagers against other players in Warzone. Bet as much or as little as you want and play people based on their skills. Sign up today." />
        </Helmet>
