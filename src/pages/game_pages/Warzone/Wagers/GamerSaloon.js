...
const GamerSaloon = () => {
  ...
  return (
    <>
        <Helmet>
          <meta name="description" content="GamerSaloon is Warzone 1v1 kill race console matches. Tired of PC players in wagers? Play these wagers against other console players today." />
        </Helmet>
