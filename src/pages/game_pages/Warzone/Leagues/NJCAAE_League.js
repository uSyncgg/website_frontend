...
const NJCAAE_League = () => {
  ...
  return (
    <>
        <Helmet>
          <meta name="description" content="NJCAAE league is a Warzone Collegiate league. Sign your college up today and compete against other schools in a kill race for cash prizes." />
        </Helmet>
