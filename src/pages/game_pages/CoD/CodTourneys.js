...
function CodTourneys() {
    ...
    return (
        <div>
            <div className="tourney-background full-height-wrapper-tourneys">
...
function Tournament(props) {
    ...
    if (tournament.prize.includes('GTD')) {
        gtd_prize = tournament.prize + ' '
    }
    ...
    if (tournament.series === 'none') {
        series_present = 'hide-on-pc hide-on-mobile'
    }
