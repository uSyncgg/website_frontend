    ...
    return (
        ...
        <div className='total-container'>
            ...
            <div className='Header-Img-l lans-img'>
                <div className="games-leagues-header-title">
                <h1 id="league-title">Call of Duty Leagues</h1>
                <img
                    ...
                    <div className='col-12 col-lg-6 space-on-bottom-mobile'>
                        ...
                        <div className='col-12 col-lg-6 bottom-card'>
                            <div className='league'>
                                ...
                                <div className='parent'>
                                    <a href="/games/call-of-duty/leagues/pulse-x-leagues"><img src="https://i.imgur.com/4dVJ11u.png" className='league-img' /></a>
                                    <a href="/more/verification"><img src="https://i.imgur.com/PCHIHQB.png" title="uSync Verified" className='over-img' /></a>
                                </div>
                        ...
                        <div className='col-12 col-lg-6 space-on-bottom-mobile'>
                            <div className='league'>
                                ...
                                <div className='parent'>
                                    <a href="/games/call-of-duty/leagues/tpc-league"><img src="https://i.imgur.com/t4k8Qi6.png" className='league-img' /></a>
                                </div>
                                <p className='Leaguep'>NA</p>
                                <a href='/games/call-of-duty/leagues/tpc-league'>
                                    <button type="submit" className='info-button'>More Info</button>
                        ...
                        <div className='col-12 col-lg-6 bottom-card'>
                            <div className='league'>
                                <a href='/games/call-of-duty/leagues/elite-gaming-warfare-league'>
                                    <h1 className='Leagueh1 hide-on-mobile'>Elite Warfare Gaming League</h1>
                                </a>
                                <div className='parent'>
                                    <a href="/games/call-of-duty/leagues/elite-gaming-warfare-league"><img src="https://i.imgur.com/7o2e5a3.png" className='league-img' /></a>
                                </div>
                                <p className='Leaguep'>NA</p>
                                <a href='/games/call-of-duty/leagues/elite-gaming-warfare-league'>
                                    <button type="submit" className='info-button'>More Info</button>
                        ...
                        <div className='league'>
                                ...
                                <div className='parent'>
                                    <a href="/games/call-of-duty/leagues/casual-xp-league"><img src="https://i.imgur.com/wW4jVQ0.png" className='league-img' /></a>
                                </div>
                                <p className='Leaguep'>All Regions</p>
                                <a href='/games/call-of-duty/leagues/casual-xp-league'>
                                    <button type="submit" className='info-button'>More Info</button>
