...
const COD_Rec_League = () => {
  ...
  return (
    <>
        <Helmet>
          <meta name="description" content="Recreational Call of Duty league for players looking for a challenge. Play weekly matches based on your skill level." />
        </Helmet>
        <div className='total-container'>
        <div className="Header-Img-l not-verified-banner-img-lans"> 
        <div className="games-leagues-header-title">
          <h1 id="league-title">Call of Duty Rec League</h1>
