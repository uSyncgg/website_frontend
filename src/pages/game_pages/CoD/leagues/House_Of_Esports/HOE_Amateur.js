...
const HOE_Amateur = () => {
  useNavHeight();
    return (
      <>
          <Helmet>
            <meta name="description" content="Worldwide Call of Duty league based in South Africa. Live streamed matches and competitive rules." />
          </Helmet>
          <div className='total-container'>
        <div className="Header-Img-l not-verified-banner-img-lans"> 
        <div className="games-leagues-header-title">
          <h1 id="league-title">House of Esports Amateur</h1>
      ...
      <div className="background-mid">
        ...
        <div className="league-back-button-container">
          <a href="/games/call-of-duty/leagues/House-of-esports-leagues" id='league-back-button-a'>
