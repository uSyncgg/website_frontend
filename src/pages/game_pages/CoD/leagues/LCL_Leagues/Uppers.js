...
const Uppers = () => {
  useNavHeight();
    return (
      <>
          <Helmet>
            <meta name="description" content="LockDown Call of Duty League is hosting LCL Uppers - the perfect league for those looking for good competition and a prize pool." />
          </Helmet>
          <div className="total-playground">
      <div className="Header-Img-l lockdown-league-verified-banner">
      <div className="games-leagues-header-title-verified">
          <h1 id="league-title">LCL Uppers League</h1>
      ...
      <div className="background-mid">
        ...
        <div className="league-back-button-container">
          <a href="/games/call-of-duty/leagues/lockdowncl-leagues" id='league-back-button-a'>
