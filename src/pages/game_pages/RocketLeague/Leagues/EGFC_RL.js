...
const EGFC_RL = () => {
  useNavHeight();
    return (
      <>
          <Helmet>
            <meta name="description" content="EGFC is a collegiate Rocket League league. Enroll today for fast-paced action. Rocket League leagues have never been more intense." />
          </Helmet>
