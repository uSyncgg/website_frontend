...
const Star = () => {
  ...
  return (
    <>
        <Helmet>
          <meta name="description" content="Grab your duo and sign up for the Rocket League star league. with a 1400 - 1599 MMR range you can compete for cash prizes and more." />
        </Helmet>
        <div className='total-container'>
        <div className="Header-Img-l not-verified-banner-img-lans"> 
        <div className="games-leagues-header-title">
          <h1 id="league-title">Star League</h1>
