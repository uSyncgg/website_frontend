...
const Expert = () => {
  ...
  return (
    <>
        <Helmet>
          <meta name="description" content="Rocket League league - Frontier Doubles Expert. 2v2 NA league where players must be from 1200 - 1399 MMR." />
        </Helmet>
        <div className='total-container'>
        <div className="Header-Img-l not-verified-banner-img-lans"> 
        <div className="games-leagues-header-title">
          <h1 id="league-title">Expert League</h1>
