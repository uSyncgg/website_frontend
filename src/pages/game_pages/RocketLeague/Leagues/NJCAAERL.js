...
const NJCAAERL = () => {
  useNavHeight();
    return (
      <>
          <Helmet>
            <meta name="description" content="Looking for a Rocket League esports league to play in while obtaining your associates degree - NCJCAAE is the league you have been searching for all this time." />
          </Helmet>
      ...
      <div className="background-mid">
        <div className="Background-mid-top">
          ...
          <a
            href="https://www.njcaaesports.org/gametitles/rocket-league"
            target="_blank"
        ...
        <div class="container">
          <div class="row">
            ...
            <h2 className="info-title leagues-entry-fee">Entry Fee:</h2>
              <p>$2,000/yr - Must be Attending a 2 Year School</p>
            </div>
          </div>
        </div>
