...
const NSERL = () => {
  useNavHeight();
    return (
      <>
          <Helmet>
            <meta name="description" content="United Kingdom Rocket League league for university students in the UK. NSE is the home of competitive division based leagues with thousands of dollars to be paid out." />
          </Helmet>
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-md-4 league-info">
              ...
              <p>£600 Total Prize Pool (Estimated)</p>
              <p>3 Divisions, Move Up Divisions Based on Placing</p>
              <p>2 Week Regular Season</p>
              <p>3 Week Playoffs and Swiss</p>
              <p>LAN Finals</p>
