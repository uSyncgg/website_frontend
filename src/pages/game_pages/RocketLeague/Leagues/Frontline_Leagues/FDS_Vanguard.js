...
const FDS_Vanguard = () => {
  ...
  return (
    <>
        <Helmet>
          <meta name="description" content="1500 - 1699 MMR Rocket League league by Frontline. FDS Vanguard is a RL league for those that are looking for free entry leagues with cash prizes." />
        </Helmet>
        <div className='total-container'>
        <div className="Header-Img-l not-verified-banner-img-lans"> 
        <div className="games-leagues-header-title">
          <h1 id="league-title">Frontline Vanguard</h1>
      ...
      <div className="background-mid">
        ...
        <div className="league-back-button-container">
          <a href="/games/RocketLeague/leagues/frontline-leagues" id='league-back-button-a'>
