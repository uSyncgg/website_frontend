...
const Champ = () => {
  ...
  return (
    <>
        <Helmet>
          <meta name="description" content="1251 - 1450 MMR range based Rocket League league. Minor League esports - Champion league. Sign yourself up today." />
        </Helmet>
        <div className='total-container'>
        <div className="Header-Img-l not-verified-banner-img-lans"> 
        <div className="games-leagues-header-title">
          <h1 id="league-title">MLE Champion</h1>
