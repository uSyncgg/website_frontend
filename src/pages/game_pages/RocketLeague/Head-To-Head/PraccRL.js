...
const PraccRL = () => {
  ...
  return (
    <>
        <Helmet>
          <meta name="description" content="Rocket League Pracc is the home of your next Rocket League scrim or XP match. Play head-to-head against other players to improve your team." />
        </Helmet>
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-md-4 league-info">
              ...
              <p>Covers all levels of competitions</p>
              <p>Various Different Platforms to Use</p>
              <p>Large Number of Users and Scrims</p>
