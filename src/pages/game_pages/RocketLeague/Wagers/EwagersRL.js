...
const EwagersRL = () => {
  ...
  return (
    <>
        <Helmet>
          <meta name="description" content="Ewagers are Rocket League wagers for all players. Play for any dollar amount of your choosing against other RL players." />
        </Helmet>
