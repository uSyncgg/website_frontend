...
const CKRAS = () => {
  ...
  return (
    <>
        <Helmet>
          <meta name="description" content="Counter-Strike 2 CKRAS server hosting for scrims. Host your server to start scrimming matches to practice for competitions." />
        </Helmet>
        <div className='total-container'>
        <div className="Header-Img-l not-verified-banner-img-lans"> 
        <div className="games-leagues-header-title">
          <h1 id="league-title">CKRAS</h1>
