...
const GamerSaloon_CS2 = () => {
  useNavHeight();
  return (
    <>
        <Helmet>
          <meta name="description" content="Counter-Strike 2 1v1 deathmatch wager matches provided by GamerSaloon. Various matches posted daily to compete head to head for cash." />
        </Helmet>
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-md-4 league-info">
              ...
              <p>1v1 Deathmatches ONLY</p>
              <p>Set Buy-In Amounts</p>
              <p>Matches Posted Daily</p>
              <p>Small Number of Users</p>
            </div>
            <div class="col-md-4 league-info">
              <h2 className="info-title">Restrictions:</h2>
              <p>18+</p>
              <p>Restricted States: AZ, IA, LA, MI, MT, NV, and SD</p>
            </div>
          </div>
        </div>
...
export default GamerSaloon_CS2;
