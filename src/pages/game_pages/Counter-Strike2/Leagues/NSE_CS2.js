...
const NSE_CS2 = () => {
  ...
  return (
    <>
      <Helmet>
        <title>NSE (National Student Esports) CS2 League | uSync</title>
        <meta name="description" content="United Kingdom based league - NSE is built specifically for university students. Win it all today." />
        <link rel="canonical" href="https://usync.gg/games/CS2/leagues/nse" />
      </Helmet>
          ...
          <div class="container">
            <div class="row">
              ...
              <div class="col-md-4 league-info">
                ...
                <p>Entry Fee TBA</p>
                <p>Must Be Attending a University</p>
              </div>
            </div>
          </div>
