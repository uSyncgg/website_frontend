...
const EGFC_CS2 = () => {
  ...
  return (
    <>
      <Helmet>
        <title>EGFC Counter-Strike 2 League | uSync</title>
        <meta name="description" content="EGFC is a Counter-Strike 2 collegiate league for D1 varsity programs in the USA. Enroll your school today." />
        <link rel="canonical" href="https://usync.gg/games/CS2/leagues/egfc" />
      </Helmet>
      <div className='total-container'>
        <div className="Header-Img-l not-verified-banner-img-lans">
          <div className="games-leagues-header-title">
            <h1 id="league-title">EGFC League</h1>
            <img 
          ...
          <div class="container">
            <div class="row">
              <div class="col-md-4 league-info">
                ...
                <p>Annual Fall - Spring Seasons</p>
              </div>
              <div class="col-md-4 league-info">
              ...
              <div class="col-md-4 league-info">
                ...
                <p>Entry Fee TBA</p>
                <p>Must Be in D1 Varsity Esports Program</p>
              </div>
            </div>
          </div>
