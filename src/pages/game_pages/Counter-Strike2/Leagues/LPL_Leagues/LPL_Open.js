...
const LPL_Open = () => {
  ...
  return (
    <>
        <Helmet>
          <meta name="description" content="Counter-Strike 2 LPL Open league is a casual league for those who want a competitive setting. Start your competitive journey today." />
        </Helmet>
        <div className='total-container'>
        <div className="Header-Img-l not-verified-banner-img-lans"> 
        <div className="games-leagues-header-title">
          <h1 id="league-title">LPL Open Division</h1>
      ...
      <div className="background-mid">
        <div className="Background-mid-top">
          ...
          <a
            href="https://gg.letsplay.live/home"
            target="_blank"
        ...
        <div class="container">
          <div class="row">
            ...
            <h2 className="info-title leagues-entry-fee">Entry Fee:</h2>
              <p>Varying Entry Fee</p>
            </div>
          </div>
        </div>
        <div className="league-back-button-container">
          <a href="/games/CS2/leagues/lpl-leagues" id='league-back-button-a'>
