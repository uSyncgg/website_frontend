...
const LPL_Gold = () => {
  ...
  return (
    <>
        <Helmet>
          <meta name="description" content="LPL Gold Counter-Strike 2 league is the premier Oceania event. Compete against others in your region at the highest level." />
        </Helmet>
        <div className='total-container'>
        <div className="Header-Img-l not-verified-banner-img-lans"> 
        <div className="games-leagues-header-title">
          <h1 id="league-title">LPL Gold Division</h1>
