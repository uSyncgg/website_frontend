...
const Intermediate_SCL = () => {
  useNavHeight();
  return (
    <>
        <Helmet>
          <meta name="description" content="Intermediate Counter-Strike 2 SCL league. Cheap to enter league with massive prize pool payouts to the winner of the playoffs." />
        </Helmet>
        <div className='total-container'>
        <div className="Header-Img-l not-verified-banner-img-lans"> 
        <div className="games-leagues-header-title">
          <h1 id="league-title">SCL Intermediate Division</h1>
...
export default Intermediate_SCL;