...
const EsportWagHalo = () => {
  ...
  return (
    <>
        <Helmet>
          <meta name="description" content="Halo Esports Wager is the place for 1v1 - 6v6 matches. Choose your wager amount and grab your teammate and make money playing Halo." />
        </Helmet>
        <div className='total-container'>
        <div className="Header-Img-l not-verified-banner-img-lans"> 
        <div className="games-leagues-header-title">
          <h1 id="league-title">Esports Wager</h1>
      ...
      <div className="background-mid">
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-md-4 league-info">
              ...
              <p>Various Game Modes / 1v1 - 6v6 Matches</p>
        ...
        <a href="/games/halo/wagers" id='league-back-button-a'>
