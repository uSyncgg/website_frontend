...
const Halo_Agent = () => {
  ...
  return (
    <>
        <Helmet>
          <meta name="description" content="Halo Agent is the league for those who love to play ranked Halo and want something more. Compete today." />
        </Helmet>
        <div className='total-container'>
        <div className="Header-Img-l not-verified-banner-img-lans"> 
        <div className="games-leagues-header-title">
          <h1 id="league-title">Halo Agent</h1>
