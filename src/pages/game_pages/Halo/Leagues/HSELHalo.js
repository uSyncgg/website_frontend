...
const HSELHalo = () => {
  useNavHeight();
    return (
      <>
          <Helmet>
            <meta name="description" content="High School Halo Esports League (HSEL). Compete with other students at your high school against other local high schools." />
          </Helmet>
      ...
      <div className="background-mid">
        ...
        <div class="container">
          <div class="row">
            <div class="col-md-4 league-info">
              ...
              <p>Fall Season Only</p>
            </div>
            <div class="col-md-4 league-info">
              <h2 className="info-title">Details:</h2>
              <p>Highly Competitive</p>
              <p>2 Weeks of Preseason, 8 Weeks of Regular Season</p>
              <p>Single Elimination Playoff Bracket</p>
        ...
        <div className="league-back-button-container">
          <a href="/games/halo/leagues" id='league-back-button-a'>
