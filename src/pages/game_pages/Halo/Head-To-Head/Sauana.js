...
const RecXP = () => {
  ...
  return (
    <>
        <Helmet>
          <meta name="description" content="The Sauana Halo scrims. Scrim finder for casual all the way to highly competitive players in the Halo scene." />
        </Helmet>
        <div className='total-container'>
        <div className="Header-Img-l not-verified-banner-img-lans"> 
        <div className="games-leagues-header-title">
          <h1 id="league-title">The Sauna Scrims</h1>
