...
const Arena = () => {
  ...
  return (
    <>
        <Helmet>
          <meta name="description" content="The Arena Halo scrims and 8s lobbies. Find free matches against other teams to practice." />
        </Helmet>
        <div className='total-container'>
        <div className="Header-Img-l not-verified-banner-img-lans"> 
        <div className="games-leagues-header-title">
          <h1 id="league-title">XXXXXXXXXXXXXXXX</h1>
