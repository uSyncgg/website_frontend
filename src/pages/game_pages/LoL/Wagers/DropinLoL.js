...
const DropinLoL = () => {
  ...
  return (
    <>
        <Helmet>
          <meta name="description" content="Compete in League of Legends for money. Join Drop-in Gaming to make money playing league. Do you have what it takes to win?" />
        </Helmet>
        <div className='total-container'>
        <div className="Header-Img-l not-verified-banner-img-lans"> 
        <div className="games-leagues-header-title">
          <h1 id="league-title">Drop-In Gaming</h1>
