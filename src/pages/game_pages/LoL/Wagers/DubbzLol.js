...
const DubbzLol = () => {
  ...
  return (
    <>
        <Helmet>
          <meta name="description" content="League of Legends howling abyss and blind pick wager matches from Dubbz. Earn cash today." />
        </Helmet>
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-md-4 league-info">
              ...
              <p>Howling Abyss and Blind Pick</p>
