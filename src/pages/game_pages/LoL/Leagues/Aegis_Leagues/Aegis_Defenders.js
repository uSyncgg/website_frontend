...
const Aegis_Defenders = () => {
  useNavHeight();
    return (
      <>
          <Helmet>
            <meta name="description" content="Aegis Defenders League is for League of Legends players with less than 100LP. Join a league that fits you today." />
          </Helmet>
            <div className="total-playground">
      <div className="Header-Img-l aegis-verified-league">
      <div className="games-leagues-header-title-verified">
          <h1 id="league-title">Aegis Defenders League</h1>
      ...
      <div className="background-mid">
        ...
        <div className="league-back-button-container">
          <a href="/games/LoL/leagues/aegis-leagues" id='league-back-button-a'>
...
export default Aegis_Defenders;
