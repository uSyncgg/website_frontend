...
const Aegis_Executioners = () => {
  useNavHeight();
    return (
      <>
          <Helmet>
            <meta name="description" content="Aegis Executive League is for League players who are lower than diamond 4. Can you win the entire league?" />
          </Helmet>
            <div className="total-playground">
      <div className="Header-Img-l aegis-verified-league">
      <div className="games-leagues-header-title-verified">
          <h1 id="league-title">Aegis Executive League</h1>
...
export default Aegis_Executioners;
