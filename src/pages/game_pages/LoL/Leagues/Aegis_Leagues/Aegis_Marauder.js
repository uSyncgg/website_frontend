...
const Aegis_Marauder = () => {
  useNavHeight();
    return (
      <>
          <Helmet>
            <meta name="description" content="Marauder League by Aegis is a Master 600LP cap League of Legends league. Make thousands playing LoL." />
          </Helmet>
            <div className="total-playground">
      <div className="Header-Img-l aegis-verified-league">
      <div className="games-leagues-header-title-verified">
          <h1 id="league-title">Aegis Marauder League</h1>
