...
const Aegis_Protectors = () => {
  useNavHeight();
    return (
      <>
          <Helmet>
            <meta name="description" content="Aegis Protectors league is an entry level League of Legends league that has a cash prize for the winning team. Try it today." />
          </Helmet>
            <div className="total-playground">
      <div className="Header-Img-l aegis-verified-league">
      <div className="games-leagues-header-title-verified">
          <h1 id="league-title">Aegis Protectors League</h1>
