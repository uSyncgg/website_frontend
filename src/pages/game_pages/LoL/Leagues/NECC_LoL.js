...
const NECC_LoL = () => {
  ...
  return (
    <>
        <Helmet>
          <meta name="description" content="Calling all college students that are playing League of Legends. This league is built for the college team and has a major cash prize pool." />
        </Helmet>
