...
const Blue_Otter_Masters = () => {
  useNavHeight();
  return (
    <>
        <Helmet>
          <meta name="description" content="600LP+ Blue Otter league - Blue Otter Masters. Prove your skill with teammates and make cash." />
        </Helmet>
        <div className='total-container'>
        <div className="Header-Img-l not-verified-banner-img-lans"> 
        <div className="games-leagues-header-title">
          <h1 id="league-title">Blue Otter Masters League</h1>
...
export default Blue_Otter_Masters;
