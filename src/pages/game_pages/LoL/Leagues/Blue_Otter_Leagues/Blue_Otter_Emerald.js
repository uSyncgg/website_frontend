...
const Blue_Otter_Emerald = () => {
  useNavHeight();
  return (
    <>
        <Helmet>
          <meta name="description" content="Join a League of Legends - Blue Otter Emerald - an Emerald 1 99LP cap league that is year round." />
        </Helmet>
        <div className='total-container'>
        <div className="Header-Img-l not-verified-banner-img-lans"> 
        <div className="games-leagues-header-title">
          <h1 id="league-title">Blue Otter Emerald League</h1>
        ...
        <div class="container">
          <div class="row">
            ...
            <h2 className="info-title leagues-entry-fee">Entry Fee:</h2>
              ...
              <p>Emerald 1 99LP Cap, 1 Diamond 4 per Team</p>
            </div>
          </div>
        </div>
...
export default Blue_Otter_Emerald;
