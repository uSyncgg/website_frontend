...
const Blue_Otter_Diamond = () => {
  ...
  return (
    <>
        <Helmet>
          <meta name="description" content="Blue Otter Diamond league is a diamond 1 99LP cap League of Legends league for competitive players in NA." />
        </Helmet>
        <div className='total-container'>
        <div className="Header-Img-l not-verified-banner-img-lans"> 
        <div className="games-leagues-header-title">
          <h1 id="league-title">Blue Otter Diamond League</h1>
        ...
        <div class="container">
          <div class="row">
            ...
            <h2 className="info-title leagues-entry-fee">Entry Fee:</h2>
              ...
              <p>Diamond 1 99LP Cap, 1 Master per Team (100LP Max)</p>
            </div>
          </div>
        </div>
