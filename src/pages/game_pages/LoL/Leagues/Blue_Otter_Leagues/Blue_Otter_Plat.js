...
const Blue_Otter_Plat = () => {
  ...
  return (
    <>
        <Helmet>
          <meta name="description" content="Blue Otter Platinum is for LoL platinum players that plat 1 99LP or lower. Do you have what it takes?" />
        </Helmet>
        <div className='total-container'>
        <div className="Header-Img-l not-verified-banner-img-lans"> 
        <div className="games-leagues-header-title">
          <h1 id="league-title">Blue Otter Platinum League</h1>
