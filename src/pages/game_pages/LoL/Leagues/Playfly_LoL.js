...
const Playfly_LoL = () => {
  useNavHeight();
    return (
      <>
          <Helmet>
            <meta name="description" content="Playfly League of Legends. The collegiate league with massive prize pools. Compete for thousands of dollars for yourself and your school." />
          </Helmet>
      <div className="total-playground">
        <div className="Header-Img-l playfly-verified-league" />
