...
const Risen_Champions = () => {
  useNavHeight();
    return (
      <>
          <Helmet>
            <meta name="description" content="Risen Champions League is the most prestigious league from Risen. Compete in this League of Legends league for thousands of dollars." />
          </Helmet>
            <div className="total-playground">
      <div className="Header-Img-l risen-verified-league">
      <div className="games-leagues-header-title-verified">
          <h1 id="league-title">Risen Champions League</h1>
