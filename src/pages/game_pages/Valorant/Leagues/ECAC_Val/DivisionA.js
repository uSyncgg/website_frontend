...
const DivisionA = () => {
  ...
  return (
    <>
        <Helmet>
          <meta name="description" content="ECAC Valorant Collegiate league Division A. Enroll your college Valorant team into the top division and compete against other top colleges across the country." />
        </Helmet>
        <div className='total-container'>
        <div className="Header-Img-l not-verified-banner-img-lans"> 
        <div className="games-leagues-header-title">
          <h1 id="league-title">ECAC Division A</h1>
      ...
      <div className="background-mid">
        ...
        <div className="league-back-button-container">
          <a href="/games/Valorant/leagues/ecac-leagues" id='league-back-button-a'>
