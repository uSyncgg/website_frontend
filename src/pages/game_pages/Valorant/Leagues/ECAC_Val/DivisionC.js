...
const DivisionC = () => {
  ...
  return (
    <>
        <Helmet>
          <meta name="description" content="Sign your college students up for the Division C ECAC Valorant League. Compete for team trophies with an 8 week regular season and playoffs." />
        </Helmet>
        <div className='total-container'>
        <div className="Header-Img-l not-verified-banner-img-lans"> 
        <div className="games-leagues-header-title">
          <h1 id="league-title">ECAC Division C</h1>
