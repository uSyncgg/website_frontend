...
const DivisionB = () => {
  ...
  return (
    <>
        <Helmet>
          <meta name="description" content="Division B league for ECAC Valorant. This Valorant college university league is the second division in the 5v5 USA format. Join today." />
        </Helmet>
        <div className='total-container'>
        <div className="Header-Img-l not-verified-banner-img-lans"> 
        <div className="games-leagues-header-title">
          <h1 id="league-title">ECAC Division B</h1>
