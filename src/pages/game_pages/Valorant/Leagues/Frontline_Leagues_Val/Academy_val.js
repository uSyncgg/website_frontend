...
const Academy_val = () => {
  ...
  return (
    <>
        <Helmet>
          <meta name="description" content="Frontline Academy Valorant League. Gold rank and lower based league. Where you sign up as a free agent and a team will draft you for the season." />
        </Helmet>
        <div className='total-container'>
        <div className="Header-Img-l not-verified-banner-img-lans"> 
        <div className="games-leagues-header-title">
          <h1 id="league-title">Frontline Academy</h1>
      ...
      <div className="background-mid">
        ...
        <div className="league-back-button-container">
          <a href="/games/Valorant/leagues/frontline-leagues" id='league-back-button-a'>
