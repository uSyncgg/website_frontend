...
const Gold = () => {
  useNavHeight();
    return (
      <>
          <Helmet>
            <meta name="description" content="LPL Gold league is a invite-only 5v5 OCE Valorant league. 3 weeks of regular seasons to compete at the highest level in Val." />
          </Helmet>
            <div className="total-playground">
      <div className="Header-Img-l lpl-verified-league">
      <div className="games-leagues-header-title-verified">
          <h1 id="league-title">LPL Gold</h1>
