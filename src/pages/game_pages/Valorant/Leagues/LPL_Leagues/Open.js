...
const Evolution = () => {
  useNavHeight();
    return (
      <>
          <Helmet>
            <meta name="description" content="Open League by LPL Leagues is a division for newer Valorant players trying to make their name in the competitive esports scene. Enroll today and find a team." />
          </Helmet>
            <div className="total-playground">
      <div className="Header-Img-l lpl-verified-league">
      <div className="games-leagues-header-title-verified">
          <h1 id="league-title">LPL Open</h1>
