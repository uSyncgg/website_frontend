...
const Playfly_VARSITY = () => {
  ...
  return (
    <>
        <Helmet>
          <meta name="description" content="Does your college have a Valorant team that wants to prove themselves - Playfly Varsity league is here for you. With thousands of dollars on the line you won't want to miss this league." />
        </Helmet>
        <div className='total-container'>
        <div className="Header-Img-l not-verified-banner-img-lans"> 
        <div className="games-leagues-header-title">
          <h1 id="league-title">Playfly Varsity</h1>
      ...
      <div className="background-mid">
        ...
        <div className="league-back-button-container">
          <a href="/games/Valorant/leagues/playfly-leagues" id='league-back-button-a'>
