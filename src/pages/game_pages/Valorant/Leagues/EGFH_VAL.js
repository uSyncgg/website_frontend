...
const EGFH_VAL = () => {
  ...
  return (
    <>
        <Helmet>
          <meta name="description" content="EGFH High School Valorant League. With annual spring and fall semester seasons this is perfect for any high school Valorant esports players looking to make a name for themselves." />
        </Helmet>
        <div className='total-container'>
        <div className="Header-Img-l not-verified-banner-img-lans"> 
        <div className="games-leagues-header-title">
          <h1 id="league-title">EGFH League</h1>
