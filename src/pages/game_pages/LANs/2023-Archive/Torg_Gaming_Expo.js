...
const Torg_Gaming_Expo = () => {
  ...
  return (
    <>
        <Helmet>
          <meta name="description" content="Torg Gaming Expo - the largest gaming convention in all of Ohio. Competitive tournaments and various different events." />
        </Helmet>
    <div className='total-container'>
<div className="Header-Img-l not-verified-banner-img-lans"> 
        <div className="games-leagues-header-title">
          <h1 id="league-title">Torg Gaming Expo</h1>
