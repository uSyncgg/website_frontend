...
const PDX_LAN_Spring_2025 = () => {
  ...
  return (
    <>
        <Helmet>
          <meta name="description" content="Spring 2025 convention for gamers across the US. Come out to Ridgefield, WA to have a blast playing your favorite games with your favorite people." />
        </Helmet>
    <div className='total-container'>
<div className="Header-Img-l not-verified-banner-img-lans"> 
        <div className="games-leagues-header-title">
          <h1 id="league-title">PDX LAN Spring 2025</h1>
