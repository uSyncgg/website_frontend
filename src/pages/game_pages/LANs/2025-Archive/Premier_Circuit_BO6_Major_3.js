...
const Premier_Circuit_BO6_Major_3 = () => {
  ...
  return (
    <>
        <Helmet>
          <meta name="description" content="Black Ops 6 Major III Premier Circuit LAN tourney. COD challenger players competing for a huge cash prize and claim to fame." />
        </Helmet>
    <div className='total-container'>
<div className="Header-Img-l not-verified-banner-img-lans"> 
        <div className="games-leagues-header-title">
          <h1 id="league-title">Premier Circuit BO6 Major 3</h1>
