...
// Add ANOTHER ../ once archived -------------------------------------------------------------------------------------------------------------------------------------------------------
const Valorant_Precision_Protocol = () => {
  useNavHeight();
  return (
    <div className='total-container'>
<div className="Header-Img-l not-verified-banner-img-lans"> 
        <div className="games-leagues-header-title">
          <h2 id="league-title">Valorant Precision Protocol</h2>
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-md-4 league-info">
              ...
              <p>Valorant Standard Ruleset Tournament</p>
              <p>16 Teams MAX, 4 Teams MIN</p>
              <p>10AM Start Time</p>
            </div>
            <div class="col-md-4 league-info">
...
export default Valorant_Precision_Protocol;
