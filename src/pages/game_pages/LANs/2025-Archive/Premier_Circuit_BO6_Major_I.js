...
const Premier_Circuit_BO6_Major_I = () => {
  ...
  return (
    <>
        <Helmet>
          <meta name="description" content="$5,000 Premier circuit Call of Duty LAN Tournament near Las Vegas. Pool play and double elimination 4v4 CDL LAN event." />
        </Helmet>
    <div className='total-container'>
<div className="Header-Img-l not-verified-banner-img-lans"> 
        <div className="games-leagues-header-title">
          <h1 id="league-title">Premier Circuit BO6 Major I</h1>
