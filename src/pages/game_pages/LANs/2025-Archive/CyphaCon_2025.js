...
const CyphaCon_2025 = () => {
  ...
  return (
    <>
        <Helmet>
          <meta name="description" content="CyphaCon 2025 is a spring LAN tournamnet with a variety of celebrity guests, contests, and more. Sign up today to play your first LAN tournament." />
        </Helmet>
    <div className='total-container'>
<div className="Header-Img-l not-verified-banner-img-lans"> 
<div className="games-leagues-header-title">
          <h1 id="league-title">CyphaCon 2025</h1>
