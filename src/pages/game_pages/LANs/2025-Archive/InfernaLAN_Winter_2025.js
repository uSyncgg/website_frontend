...
const InfernaLAN_Winter_2025 = () => {
  ...
  return (
    <>
        <Helmet>
          <meta name="description" content="Winter 2025 Washington state Halo LAN event with throwback Halo games and more. Compete in Rocket League LAN event near you." />
        </Helmet>
    <div className='total-container'>
<div className="Header-Img-l not-verified-banner-img-lans"> 
        <div className="games-leagues-header-title">
          <h1 id="league-title">InfernaLAN Winter 2025</h1>
