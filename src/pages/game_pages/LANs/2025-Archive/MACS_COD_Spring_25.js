...
const MACS_COD_Spring_25 = () => {
  ...
  return (
    <>
        <Helmet>
          <meta name="description" content="MACS Spring 2025 is for college players andteams in the greater Colorado area looking to compete in a CDL variant LAN event." />
        </Helmet>
