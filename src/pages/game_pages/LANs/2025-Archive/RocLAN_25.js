...
const RocLAN_25 = () => {
  ...
  return (
    <>
        <Helmet>
          <meta name="description" content="RocLAN 25 is back again this April 11 - 13th. Join for various LAN events, raffles, and contests for the whole family." />
        </Helmet>
    <div className='total-container'>
<div className="Header-Img-l not-verified-banner-img-lans"> 
        <div className="games-leagues-header-title">
          <h1 id="league-title">RocLAN 25</h1>
