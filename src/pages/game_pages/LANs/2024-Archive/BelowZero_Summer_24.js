...
const BelowZero_Summer_24 = () => {
  ...
  return (
    <>
        <Helmet>
          <meta name="description" content="Bring Your Own Computer LAN convention for charity in Roseville, MN. Come join everyone attending." />
        </Helmet>
    <div className='total-container'>
<div className="Header-Img-l not-verified-banner-img-lans"> 
        <div className="games-leagues-header-title">
          <h1 id="league-title">BelowZero Summer 24</h1>
