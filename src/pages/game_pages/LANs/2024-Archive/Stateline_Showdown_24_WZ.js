...
const Stateline_Showdown_24_WZ = () => {
  ...
  return (
    <>
        <Helmet>
          <meta name="description" content="Stateline Showdown is a Warzone duo kill race hosted by the US National Guard. Play for cash in Missouri at thee LevelUp Arena." />
        </Helmet>
    <div className='total-container'>
<div className="Header-Img-l not-verified-banner-img-lans"> 
        <div className="games-leagues-header-title">
          <h1 id="league-title">Stateline Showdown 24 WZ</h1>
