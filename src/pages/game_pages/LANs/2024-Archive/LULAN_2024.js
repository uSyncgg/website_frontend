...
const LULAN_2024 = () => {
  ...
  return (
    <>
        <Helmet>
          <meta name="description" content="Lynchburg, Virginia LAN event with BO6, Rainbow 6 Siege, and Valorant LAN tournaments this November. Hosted entirely for Collegiate esports teams." />
        </Helmet>
    <div className='total-container'>
<div className="Header-Img-l not-verified-banner-img-lans"> 
        <div className="games-leagues-header-title">
          <h1 id="league-title">LULAN 2024</h1>
