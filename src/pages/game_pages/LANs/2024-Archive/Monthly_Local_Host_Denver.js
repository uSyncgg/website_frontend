...
// Add ANOTHER ../ once archived -------------------------------------------------------------------------------------------------------------------------------------------------------
const Monthly_Local_Host_Denver = () => {
  return (
    <div className='total-container'>
    <header id='League-header'>
        <img src="https://i.imgur.com/MewGRdo.png" className='Header-Img' />
        <div className="games-leagues-header-title">
            <h2 id="league-title">Monthly Local Host Denver</h2>
        ...
        <div class="container">
          <div class="row">
            <div class="col-md-4 league-info">
              ...
              <p>December 14th, 2024</p>
              <p>Lakewood, CO</p>
            </div>
            <div class="col-md-4 league-info">
              <h2 className="info-title">Details:</h2>
              <p>$800 Prize Pool (based on entrants)</p>
              <p>11AM Start Time</p>
...
export default Monthly_Local_Host_Denver;
