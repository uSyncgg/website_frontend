...
const Galaxycon_2024 = () => {
  ...
  return (
    <>
        <Helmet>
          <meta name="description" content="Halo and Halo Infinite 2v2 LAN tournament near Oklahoma City, OK. Cheap entry fee and the prize pool will be huge." />
        </Helmet>
    <div className='total-container'>
<div className="Header-Img-l not-verified-banner-img-lans"> 
        <div className="games-leagues-header-title">
          <h1 id="league-title">Galaxycon 2024</h1>
