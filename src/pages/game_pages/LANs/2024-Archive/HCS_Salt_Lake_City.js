...
// Add ANOTHER ../ once archived -------------------------------------------------------------------------------------------------------------------------------------------------------
const HCS_Salt_Lake_City = () => {
  useNavHeight();
  return (
    <>
        <Helmet>
          <meta name="description" content="Salt Lake City, Utah hosts the Halo Championship Series this September. Sign up before the limited passes sell out." />
        </Helmet>
    <div className='total-container'>
<div className="Header-Img-l not-verified-banner-img-lans"> 
        <div className="games-leagues-header-title">
          <h1 id="league-title">HCS Salt Lake City Utah</h1>
...
export default HCS_Salt_Lake_City;
