...
const HCS_Arlington_2024 = () => {
  ...
  return (
    <>
        <Helmet>
          <meta name="description" content="HCS Arlington is the Optic Gaming hosted Halo Infinite event in Optic's home turf - Texas. Compete for hudnreds of thousands of dollars this March." />
        </Helmet>
    <div className='total-container'>
<div className="Header-Img-l not-verified-banner-img-lans"> 
        <div className="games-leagues-header-title">
          <h1 id="league-title">HCS Arlington 2024</h1>
