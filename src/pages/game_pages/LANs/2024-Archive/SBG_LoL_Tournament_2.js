...
const SBG_LoL_Tournament_2 = () => {
  ...
  return (
    <>
        <Helmet>
          <meta name="description" content="League of Legends tournament hosted by SBG. Summoner's Rift single elimination LoL LAN tournament with over 8 different teams." />
        </Helmet>
    <div className='total-container'>
<div className="Header-Img-l not-verified-banner-img-lans"> 
        <div className="games-leagues-header-title">
          <h1 id="league-title">SBG LoL Tournament 2</h1>
