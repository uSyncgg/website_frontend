...
const RVA_1v1_Gunfight_2024 = () => {
  ...
  return (
    <>
        <Helmet>
          <meta name="description" content="1v1 Call of Duty gunfight tournamnet with a double elimination bracket. Rocket League, SF6, and more for esports players to compete in-person." />
        </Helmet>
    <div className='total-container'>
<div className="Header-Img-l not-verified-banner-img-lans"> 
        <div className="games-leagues-header-title">
          <h1 id="league-title">RVA 1v1 Gunfight 2024</h1>
