...
const Midwest_MW3_LAN = () => {
  ...
  return (
    <>
        <Helmet>
          <meta name="description" content="Modern Warfare 3 amateur LAN tourney in  this August. 4v4 CDL rules and a prize pool based on entrants you won't want to miss this." />
        </Helmet>
    <div className='total-container'>
<div className="Header-Img-l not-verified-banner-img-lans"> 
        <div className="games-leagues-header-title">
          <h1 id="league-title">Midwest MW3 LAN</h1>
