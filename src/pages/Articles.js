           ...
           <div className="Background-game ">
             <div className="container">
               <div className="row justify-content-center games-row-1">
                 ...
                 <div className="col-lg-4 space-on-bottom problem-with-esports-img" id="bubblel">
                   <a href="/more/FAQ/The-Problem-With-Esports">
                    <img
                      className="blockimg img-fluid d-block mx-auto"
                      src="https://i.imgur.com/vBqSUhI.png"
                      alt="img"
                    />
                  </a>
                 </div>
                  <div className="col-lg-4 space-on-bottom we-fix-img" id="bubbler">
                 ...
                 <div className="col-lg-4 space-on-bottom we-provide-img" id="bubble">
               ...
               <div className="row justify-content-center games-row-2">
                 <div className="col-lg-4 space-on-bottom join-esports-img" id="bubblelb">
                 ...
                 <div className="col-lg-4 esports-better-img" id="bubblerb">
