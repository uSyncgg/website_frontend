                ...
                <div className="container-fluid">
                    <div className="row FAQ-container">
                        ...
                        <div className="col-lg-8">
                            <h5 className="purple-text">HOW TO JOIN AN ESPORTS LEAGUE</h5>
                        </div>
                    </div>
                    ...
                    <div className="row">
                        ...
                        <div className="col-lg-8 article-border article-background">
                            <h7 className="black-text">How to Join an Esports League: A Complete Guide</h7>
                            ...
                            <h7 className="black-text">How to Join a COD League</h7>
                            <p className="white-text">
                            ...
                            <ol>
                                <li className="white-text">
                                    Find Active Leagues -
                                    <a href="http://localhost:3000/games/call-of-duty/leagues">Check out Call of Duty leagues on uSync</a>
                                    .
                                </li>
                                <li className="white-text">
                            ...
                            <h7 className="black-text">How to Join a Rocket League League</h7>
                            <p className="white-text">
                            ...
                            <ol>
                                <li className="white-text">
                                    ...
                                    <a href="http://localhost:3000/games/RocketLeague/leagues">Find Rocket League leagues on uSync</a>
                                    .
                                </li>
                                <li className="white-text">
                            ...
                            <p className="white-text">Joining a RL league is easy, and with uSync, you can find the right competition level for your playstyle.</p>

                            <h7 className="black-text">How to Join a Valorant League</h7>
                            <p className="white-text">
                            ...
                            <ol>
                                <li className="white-text">
                                    ...
                                    <a href="http://localhost:3000/games/Valorant/leagues">uSync's Valorant leagues</a>
                            ...
                            <h7 className="black-text">How to Join a Warzone League</h7>
                            <p className="white-text">
                            ...
                            <ol>
                                <li className="white-text">
                                    ...
                                    <a href="http://localhost:3000/games/warzone/leagues">uSync's Warzone leagues</a>
                            ...
                            <h7 className="black-text">How to Join a CS-2 League</h7>
                            <p className="white-text">
                            ...
                            <ol>
                                <li className="white-text">
                                    ...
                                    <a href="http://localhost:3000/games/CS2/leagues">uSync's CS-2 leagues</a>
                            ...
                            <h7 className="black-text">How to Join a Halo Infinite League</h7>
                            <p className="white-text">
                            ...
                            <ol className="white-text">
                                <li>
                                    ...
                                    <a href="http://localhost:3000/games/halo/leagues">Explore Halo Infinite leagues here</a>
                                    .
                                </li>
                                <li>
                            ...
                            <h7 className="black-text">How to Join a League of Legends League</h7>
                            <p className="white-text">
                            ...
                            <ol className="white-text">
                                <li>
                                    ...
                                    <a href="http://localhost:3000/games/LoL/leagues">Check out League of Legends leagues here</a>
                                    .
                                </li>
                                <li>
                            ...
                            <br />
                            <p className="white-text">Join an esports league today and start competing in the best leagues in gaming!</p>
                        </div>
                    </div>
                </div>
            </div>
